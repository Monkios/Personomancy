...
?>
			<tr>
				...
				<td><a href="?s=super&a=updateChoixCapaciteRaciale&i=<?php echo $choix_capacites_raciales->id; ?>">Modifier</a></td>
			</tr>
<?php
		}
	}
?>
		...
		<form method="post" action="?s=super&a=listChoixCapacitesRaciales">
