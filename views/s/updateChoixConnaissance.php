		...
		<a href="?s=super&a=listChoixConnaissances">Retourner à la liste</a>
		<div>
			<form method="post" action="?s=super&a=updateChoixConnaissance&i=<?php echo $choixConnaissance->id; ?>">
				<div>
					<label for="choix_connaissance_nom">Nom :</label>
					<input type="text" name="choix_connaissance_nom" id="choix_connaissance_nom" value="<?php echo $choixConnaissance->nom; ?>" />
				</div>
				<div>
