		...
		<a href="?s=admin&a=listChoixCapacitesRaciales">Retourner à la liste</a>
		<div>
			<form method="post" action="?s=admin&a=updateChoixCapaciteRaciale&i=<?php echo $choixCapaciteRaciale->id; ?>">
				<div>
