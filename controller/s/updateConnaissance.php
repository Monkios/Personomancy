<?php
	if( is_numeric( $_GET["i"] ) ){
		...
		if( isset( $_POST["connaissance_id"] ) && $_GET["i"] == $_POST["connaissance_id"] ){
			...
			header( "Location: ?s=super&a=updateConnaissance&i=" . $connaissance->id );
			die();
		}
	} else {
	...
	$nav_links = array( "Liste des connaissances" => "?s=super&a=listConnaissances" );
	
	include "./views/top.php";
	include "./views/s/updateConnaissance.php";
