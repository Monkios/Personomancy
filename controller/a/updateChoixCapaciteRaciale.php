<?php
	if( is_numeric( $_GET["i"] ) ){
		...
		if( isset( $_POST["choix_capacite_raciale_id"] ) && $_GET["i"] == $_POST["choix_capacite_raciale_id"] ){
			...
			header( "Location: ?s=admin&a=updateChoixCapaciteRaciale&i=" . $choixCapaciteRaciale->id );
			die();
		}
	} else {
	...
	$nav_links = array( "Liste des choix de capacité raciale" => "?s=admin&a=listChoixCapacitesRaciales" );
